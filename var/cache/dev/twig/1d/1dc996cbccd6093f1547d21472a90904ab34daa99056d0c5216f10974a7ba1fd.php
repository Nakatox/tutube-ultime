...
";
        ...
        echo "
            ";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "link", [], "any", false, false, false, 12), 'row');
        echo "
        </div>
...
";
    ...
    {
        return array (  97 => 16,  90 => 12,  86 => 11,  82 => 10,  76 => 7,  71 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
