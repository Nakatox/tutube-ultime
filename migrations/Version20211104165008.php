...
final class Version20211104165008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, name VARCHAR(500) NOT NULL, description LONGTEXT NOT NULL, publication_date DATE NOT NULL, views INT NOT NULL, link VARCHAR(500) NOT NULL, thumbnail VARCHAR(500) NOT NULL, INDEX IDX_7CC7DA2C79F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
